...
const double R_min         = - 5.0 * r_jacobi;
const double R_max         =   5.0 * r_jacobi;
...
const double z_min         = - 5.0 * r_jacobi;
const double z_max         =   5.0 * r_jacobi;
  ...
  for(size_t i = 0; i < num_pts; i ++)
    {
      ...
      if (rank == 0) cout << "# " << R_vector[i] << " " << z_vector[i] << " " << v_R_vector[i] << " " << v_R_theta_vector[i] << endl;
    }
	      ...
	      for (size_t ivy = 0; ivy < num_pts; ivy++)
		{
		  ...
		  for (size_t ivz = 0; ivz < num_pts; ivz++)
		      ...
		      if ( (R == R_cl) && (z == 0.0) && (v_R == 0.0) && (v_R_theta == 0.0) && (v_z == 0.0) )
			{
		      ...
		      //cout << "#\n# Initial conditions: " << R << " " << R_theta << " " << z << " " << v_R << " " << v_R_theta << " " << v_z << endl;
		      ...
		      const double potential_i = - G_M_host / r_total_i - G_M_cl / rij_i + 0.5 * nu_sq * z_i * z_i;
...
// 			    }		
		      ...
		      const double potential_f = - G_M_host / r_total_f - G_M_cl / rij_f + 0.5 * nu_sq * z_f * z_f;
  ...
  //if (rank == 0) cout << endl << "# finished integration" << endl;
